...
import type {AccountKind, CreditCardBalance, FrequentPayment} from '../../domain/entities/ContractBalance';
...
export function HomeScreen() {
    ...
    const navigation = useNavigation<BottomTabNavigationProp<MainTabParamList, 'ConsolidatedPosition'>>();
    const navigationStack = useNavigation<NativeStackNavigationProp<HomeStackParamList, 'Home'>>();
    const route = useRoute<RouteProp<MainTabParamList, 'ConsolidatedPosition'>>();
    ...
    const creditProductNav = (creditCardBalance: CreditCardBalance) => {
        navigationStack.navigate('ConsolidatedPositionDetailScreen')
    }
                            ...
                            <View>
                                {frequentPayments.map((fp, i) => (
                                    <FrequentPaymentRow
                                        ...
                                        icon={iconForFrequentPayment(fp.beneficiaryType, colors.textTertiary)}
                                        isFirst={i === 0}
